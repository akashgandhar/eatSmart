      ...
      <div class="h-full flex flex-col bg-gray-100 dark:bg-gray-700 shadow-xl overflow-y-scroll">
        ...
        <div class="bg-green-300 shadow-lg pb-3 rounded-b-3xl">
          <div class="flex  rounded-b-3xl bg-gray-100 dark:bg-gray-700 space-y-5 flex-col items-center py-7">
            <a href="#">
              {' '}
              <span class="text-h1">Michele</span>
            </a>
          </div>
          <div class="grid px-7 py-2  items-center justify-around grid-cols-3 gap-4 divide-x divide-solid ">
            <div class="col-span-1 flex flex-col items-center ">
              <span class="text-2xl font-bold dark:text-gray-500">Current Medical condition</span>
              <span class="text-lg font-medium 0">Diabetes-type 1</span>
            </div>
            <div class="col-span-1 px-3 flex flex-col items-center ">
              <span class="text-2xl font-bold dark:text-gray-500"></span>
              <span class="text-lg font-medium">Plan</span>
            </div>
            <div class="col-span-1 px-3 flex flex-col items-center ">
              <span class="text-2xl font-bold dark:text-gray-500">546</span>
            ...
            <div class="flex flex-col items-center ">
              <a href="">
                ...
                <button class="tr-300">
                  ...
                  <span class="text-lg font-medium">Akshay Sharma</span>
                </button>
              </a>
            </div>
          </div>
            ...
            <div class="flex flex-col items-center ">
              <a href="">
                ...
                <button class="tr-300">
                  ...
                  <span class="text-lg font-medium">DOB</span>
                </button>
              </a>
            </div>
          </div>
            ...
            <div class="flex flex-col items-center ">
              <a href="">
                ...
                <button class="tr-300">
                  ...
                  <span class="text-lg font-medium">Disease Select</span>
                </button>
              </a>
            </div>
          </div>
            ...
            <div class="flex flex-col items-center ">
              <a href="">
                <button class="tr-300">
                  ...
                  <span class="text-lg font-medium">Allergies Select</span>
                </button>
              </a>
            </div>
          </div>
            ...
            <div class="flex flex-col items-center ">
              <a href="">
                ...
                <button class="tr-300">
                  ...
                  <span class="text-lg font-medium">BMI</span>
                </button>
              </a>
            </div>
          </div>
            ...
            <div class="flex  flex-col items-center ">
              <a href="">
                ...
                <button class="tr-300">
                  ...
                  <span class="text-lg font-medium">Home Page</span>
                </button>
              </a>
            </div>
          </div>
        ...
        <div class="flex mx-auto mt-3 w-100 ">
          <a href="">
            {' '}
            <button class="p-2 shadow-lg  tr-300 w-100 font-medium  bg-green-500 rounded-md hover:bg-green-600 text-gray-50">
              Mejorar membresía
            </button>
          </a>
        </div>
